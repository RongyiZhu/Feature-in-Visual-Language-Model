...
All experiments use bf16 weights on 32\,GB accelerators. 
...
features are treated as separate settings (\cref{sec:exp_axes}). Each
...
answer priors (behaviour). All acceptance criteria and headline layers were
